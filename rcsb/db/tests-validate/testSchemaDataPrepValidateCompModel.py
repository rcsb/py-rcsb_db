...
logging.basicConfig(filename="testSchemaDataPrepValidateCompModel.log",filemode='a',level=logging.INFO, format="%(asctime)s [%(levelname)s]-%(module)s.%(funcName)s: %(message)s")
