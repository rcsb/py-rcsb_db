...
exdb_repo_load_cli  --mock --full  --load_pdbx_core           --working_path ./test-output  --config_path ../../mock-data/config/dbload-setup-example.cfg --config_name DEFAULT --save_file_list_path ./test-output/LATEST_PDBX_CORE_LOAD_LIST.txt --fail_file_list_path ./test-output/failed-pdbx-core-path-list.txt >& ./test-output/LOGPDBXCOREFULL
#