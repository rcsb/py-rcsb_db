...
class BirdLoaderTests(unittest.TestCase):
    ...
    def testBirdSchemaCreate(self):
        ...
        """
        try:
            msd, dbName, _, _ = self.__schU.getSchemaInfo(schemaName='bird')
            #
    ...
    def __testMakeLoadPrdFiles(self):
        ...
        """
        try:
            loadPathList = self.__schU.getPathList(schemaName='bird')
    ...
    def testBirdBatchImport(self):
        ...
        try:
            ...
            sd, databaseName, _, _ = self.__schU.getSchemaInfo(schemaName='bird')
